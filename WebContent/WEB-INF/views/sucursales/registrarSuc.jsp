...
<div class="container">
	...
	<form:form id="form" action="${pageContext.request.contextPath}/sucursal/registrar" method="POST" modelAttribute="editarDTO">
		<form:input type="hidden" name="id" value="1" path="idSucursal"/>
			...
			<div class="row">
				<div class="form-group col-12">
				<input id="enviar" type = "submit" value="Agregar" style="background-color:green;">
				</div>
			</div>
		</form:form>
</div>
